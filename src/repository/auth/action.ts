...
import { LoginRequest, LoginResponse, SessionPayload, LoginUser, RegisterRequest, RegisterUser, RegisterResponse, GenerateKodeRequest, GenerateKodeData, GenerateKodeResponse } from "./dto";
...
): Promise<ActionResult<LoginUser>> {
  // 1. Call backend
